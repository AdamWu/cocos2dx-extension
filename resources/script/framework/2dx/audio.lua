...
function M.isEffectPlaying(filename)
    return sharedEngine:isEffectPlaying(filename)
end
...
function M.playMusic(filename, isLoop)
    ...
    return sharedEngine:playBackgroundMusic(filename, loopValue)
end
