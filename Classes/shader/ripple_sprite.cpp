...
bool RippleSprite::initWithFile(const char* filename)
{
	...
	const char* fs = CCString::createWithContentsOfFile("shader/efx_ripple.fsh")->getCString();
	...
	m_texNoise = CCTextureCache::sharedTextureCache()->addImage("noise_2d_std.png");
